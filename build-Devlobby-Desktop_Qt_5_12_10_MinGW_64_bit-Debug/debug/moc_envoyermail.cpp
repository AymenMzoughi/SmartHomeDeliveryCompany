...
#include "../../code intégration/envoyermail.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_EnvoyerMail_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(4, 31, 6) // "browse"

    },
    "EnvoyerMail\0sendMail\0\0mailSent\0browse"
};
...
void EnvoyerMail::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EnvoyerMail *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject EnvoyerMail::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_EnvoyerMail.data,
    qt_meta_data_EnvoyerMail,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *EnvoyerMail::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EnvoyerMail.stringdata0))
